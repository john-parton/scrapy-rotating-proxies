from scrapy.extesions.httpcache import DummyPolicy, RFC2616Policy
...
class RetryPolicyMixin:
    def is_cached_response_fresh(cachedresponse, request):
...
class RetryRFC2616Policy(RetryPolicyMixin, RetryRFC2616Policy):
    pass
